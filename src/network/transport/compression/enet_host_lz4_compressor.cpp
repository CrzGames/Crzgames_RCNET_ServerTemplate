...
void ServerNetworkCompression_EnsureHostCompressorInstalled(ENetHost* host)
{
    ...
    static ServerNetworkHostLz4CompressorContext compressorContext{};
    static ENetCompressor compressor = {
        &compressorContext,
        ServerNetworkCompression_Lz4CompressCallback,
        ServerNetworkCompression_Lz4DecompressCallback,
    ...
    RCNET_log(RCNET_LOG_INFO, "[SERVER] [NETWORK_COMPRESSION] - ENet host LZ4 compressor installed");
}
